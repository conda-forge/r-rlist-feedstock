...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-rlist-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-rlist-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-rlist-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-rlist-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-rlist-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-rlist-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-rlist/badges/version.svg)](https://anaconda.org/conda-forge/r-rlist)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-rlist/badges/downloads.svg)](https://anaconda.org/conda-forge/r-rlist)
